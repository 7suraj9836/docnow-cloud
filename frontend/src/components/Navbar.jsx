    ...
    <div className="flex items-center justify-between text-sm py-4 mb-5 border-b border-b-gray-400">
      ...
      <ul className="hidden md:flex items-start gap-5 font-medium ">
        <NavLink to="/">
          ...
          <hr className="border-none outline-none h-0.5 bg-primary w-/5 m-auto hidden" />
        </NavLink>
        <NavLink to="/doctors">
      ...
      <div className="flex items-center gap-4">
        ...
        <div className={`${showMenu ? 'fixed w-full' : 'h-0 w-0'} md:hidden right-0 top-0 bottom-0 z-0 overflow-hidden bg-white transition-all`}>
          ...
          <ul className="flex flex-col items-center gap-2 mt-5 px-5 text-lg font-medium">
            ...
            <NavLink to='/doctors' onClick={()=>setShowMenu(false)}><p className='px-4 py-2 rounded inline-block'>
            ALL DOCTORS</p> </NavLink>
