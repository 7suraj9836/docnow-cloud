...
const doctorProfile=async (req,res)=>{
  ...
  if(profileData){
    ...
    res.json({success:false,message:"Doctor Info not found"});
   }
  } catch (error) {
    res.json({success:false,message:error.message});
  }
...
const updateDoctorProfile=async (req,res)=>{
  try {
        ...
        const updateDoctorProfile=await doctorModel.findByIdAndUpdate(docId,{fees, address, available});
